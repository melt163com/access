      ...
      <el-main>
        <div class="inside-main-box">
          ...
          >
            ...
            <el-col :span="8">
              <el-form-item label="供应商分类" size="small">
            ...
            <el-col :span="4" style="margin-left: 20px">
              ...
              <el-button size="small" :icon="Plus" class="add-but"
                >新增</el-button
              >
        ...
        <div style="background: #fff">
          <el-table :data="tableData" style="width: 100vw">
            ...
            <el-table-column prop="供应商分类" label="供应商分类" width="100" />
            <el-table-column prop="法人" label="法人" width="100" />
            <el-table-column prop="营业执照" label="营业执照" width="100" />
            <el-table-column prop="商务对接人" label="商务对接人" width="100" />
            <el-table-column prop="对接人电话" label="对接人电话" width="100" />
            <el-table-column prop="合同" label="合同" width="100" />
            <el-table-column prop="服务类别" label="服务类别" width="100" />
            <el-table-column prop="服务项" label="服务项" width="100" />
            <el-table-column
              prop="环保负责人"
              label="环保负责人+信息"
              width="100"
