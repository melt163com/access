            ...
            <el-main>
                    ...
                    <el-row class="inside-main" style="background: #fff;padding-top: 10px;height: 46px;">
                        <el-col :span="8" style="margin-left: 20px;">
                            <el-form-item label="分类名称" size="small">
                                <el-input v-model="form.num" placeholder="请输入分类名称"/>
                            </el-form-item>
                        </el-col>
                ...
                <div style="background: #fff;">
                    <el-table :data="tableData" style="width: 100vw;">
                        ...
                        <el-table-column align="center" prop="分类名称" label="分类名称" />
                        <el-table-column align="center" prop="父级分类" label="父级分类" />
                        <el-table-column align="center" prop="深度" label="深度" />
                        <el-table-column align="center" prop="描述" label="描述" />
