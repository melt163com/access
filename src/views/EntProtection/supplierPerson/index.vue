            ...
            <el-header class="inside-header">
                <div>
                    ...
                    <el-breadcrumb separator=">">
                        ...
                        <el-breadcrumb-item class="breadcrumbColor">供应商人员管理</el-breadcrumb-item>
                    </el-breadcrumb>
                </div>
            </el-header>
            <el-main>
                <div class="inside-main-box">
                    <el-row :gutter="10" class="inside-main" style="background: #fff;padding-top: 10px;height: 46px;">
                        ...
                        <el-col :span="4">
                            <el-form-item label="人员类型" size="small">
                ...
                <div style="background: #fff;">
                    <el-table :data="tableData" style="width: 100vw;">
                        ...
                        <el-table-column prop="所属供应商" label="所属供应商" width="100" />
                        <el-table-column prop="电话" label="电话" width="100" />
                        <el-table-column prop="证件" label="证件" width="100" />
                        <el-table-column prop="人员类型" label="人员类型" width="100" />
                        <el-table-column prop="签属日期" label="签属日期" width="100" />
                        <el-table-column prop="服务时间" label="服务时间" width="100" />
                        <el-table-column prop="职位" label="职位" width="100" />
                        <el-table-column prop="事项记录" label="事项记录" width="100" />
                        <el-table-column prop="维保日志" label="维保日志" width="100" />
