            ...
            <el-main>
                ...
                <div style="background: #fff;">
                    <el-table :data="tableData" style="width: 100%;">
                        ...
                        <el-table-column align="center" prop="合同名称" label="合同名称" />
                        <el-table-column align="center" prop="供应商名称" label="供应商名称" />
                        <el-table-column align="center" prop="合同编号" label="合同编号" />
                        <el-table-column align="center" prop="服务类别" label="服务类别" />
                        <el-table-column align="center" prop="合同签署人" label="合同签署人" />
                        <el-table-column align="center" prop="验收专家" label="验收专家" />
                        <el-table-column align="center" prop="验收成员" label="验收成员" />
                        <el-table-column align="center" prop="验收时间" label="验收时间" />
                        <el-table-column align="center" prop="合同执行时间" label="合同执行时间" />
                        <el-table-column align="center" prop="服务时间" label="服务时间" />
