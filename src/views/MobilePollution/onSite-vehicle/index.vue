...
<div style="background: #fff;">
    <el-table :data="tableData" style="width: 100vw;">
        ...
        <el-table-column prop="环保登记编码内部管理号牌" label="环保登记编码内部管理号牌" width="100" />
        <el-table-column prop="车辆颜色" label="车辆颜色" width="80" />
        ...
        <el-table-column prop="车辆类型" label="车辆类型" width="100" />
        <el-table-column prop="注册时间" label="注册时间" width="140" />
