                        ...
                        <el-col :span="8">
                            <el-form-item label="出入类型">
                                <el-select v-model="form.type" placeholder="请选择">
                                    <el-option label="入厂" value="shanghai" />
                                    <el-option label="出厂" value="beijing" />
                                </el-select>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="送货">
                                <el-select v-model="form.type" placeholder="请选择">
                                    <el-option label="入厂" value="shanghai" />
                                    <el-option label="出厂" value="beijing" />
                                </el-select>
                    ...
                    <el-row>
                        <el-col :span="16">
                            <el-form-item label="同行人员">
                                <el-input style="height: 60px;width: 640px;" v-model="form.name" placeholder="请输入姓名、身份证号、联系方式" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row :gutter="10">
                    ...
                    <el-row>
                        ...
                        <el-col :span="8">
                            <el-form-item label="车牌颜色">
                                <el-select v-model="form.type" placeholder="请选项">
                    ...
                    <el-row>
                        <el-col :span="8">
                            <el-form-item label="车型描述">
                                <el-select v-model="form.type" placeholder="请选择">
                                    <el-option label="小面包" value="shanghai" />
                                    <el-option label="出厂" value="beijing" />
                                </el-select>
                            </el-form-item>
                        </el-col>
                        ...
                        <el-col :span="8">
                            <el-form-item label="燃料类型">
                                <el-select v-model="form.type" placeholder="请选择">
                                    ...
                                    <el-option label="柴油" value="beijing" />
                                </el-select>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="排放阶段">
                                <el-select v-model="form.type" placeholder="请选择">
                                    <el-option label="国IV" value="shanghai" />
                                    <el-option label="出厂" value="beijing" />
                                </el-select>
                            </el-form-item>
                        </el-col>
                    ...
                    <el-row :gutter="10">
                        ...
                        <el-col :span="8">
                            <el-form-item label="使用性质">
                                <el-select v-model="form.type" placeholder="请选择">
                                    <el-option label="非营运" value="shanghai" />
                                    <el-option label="营运" value="beijing" />
                                </el-select>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="16">
                            <el-form-item label="地址">
                                <el-input style="width: 650px;" v-model="form.name" placeholder="请填写" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
