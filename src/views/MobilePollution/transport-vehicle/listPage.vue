...
<div style="background: #fff;">
    <el-table :data="tableData" style="width: 100vw;">
        ...
        <el-table-column prop="类型" label="类型" width="50" />
        <el-table-column prop="车牌" label="车牌" width="80" />
        <el-table-column prop="车辆照片" label="车辆照片" width="100" />
        <el-table-column prop="随车清单" label="随车清单" width="100" />
        <el-table-column prop="行驶证" label="行驶证" width="100" />
        <el-table-column prop="健康码" label="健康码" width="100" />
        <el-table-column prop="申请时间" label="申请时间" width="140" />
        <el-table-column prop="排放标准" label="排放标准" width="100" />
