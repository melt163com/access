        ...
        <el-container>
            ...
            <el-main>
                <div class="inside-main-box">
                    <el-row class="inside-main" style="background: #fff;padding-top: 10px;height: 85px;">
...
<div style="background: #fff;">
    <el-table :data="tableData" style="width: 100%;">
        ...
        <el-table-column align="center" prop="车辆识别代码" label="车辆识别代码(VIN)" />
        <el-table-column align="center" prop="发动机号码" label="发动机号码" />
        <el-table-column align="center" prop="注册时间" label="注册时间" />
        <el-table-column align="center" prop="运输货物" label="运输货物" />
        <el-table-column align="center" prop="运输货量" label="运输货量/吨" />
    </el-table>
