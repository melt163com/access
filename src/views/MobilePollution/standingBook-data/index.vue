      ...
      <el-main>
        ...
        <div style="background: #fff; margin-top: 20px">
          <el-table :data="tableData" style="width: 100vw">
            ...
            <el-table-column prop="状态" label="状态" width="50" />
            <el-table-column prop="类型" label="类型" width="80" />
            <el-table-column prop="门禁号" label="门禁号" width="100" />
            <el-table-column prop="道闸编号" label="道闸编号" width="100" />
            <el-table-column prop="车牌" label="车牌" width="100" />
            <el-table-column prop="排放阶段" label="排放阶段" width="100" />
            <el-table-column prop="司机" label="司机" width="140" />
            <el-table-column prop="司机电话" label="司机电话" width="100" />
            <el-table-column prop="出入时间" label="出入时间" width="100" />
            <el-table-column prop="查看视频" label="查看视频" width="100" />
            <el-table-column prop="查看照片" label="查看照片" width="100" />
            <el-table-column label="操作" width="120">
              <template #default>
                <el-button link type="primary" size="small" @click="detailPage"
                  >详情</el-button
                >
              </template>
</el-table-column>
