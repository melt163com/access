...
<div style="background: #fff;">
    <el-table :data="tableData" style="width: 100%;">
        ...
        <el-table-column align="center" prop="环保登记编码" label="环保登记编码" />
        <el-table-column align="center" prop="机械环保代码" label="机械环保代码" />
        <el-table-column align="center" prop="车辆铭牌照片" label="车辆铭牌照片" />
        ...
        <el-table-column align="center" prop="注册日期" label="注册日期" />
