            ...
            <el-header class="inside-header">
                <div>
                    ...
                    <el-breadcrumb separator=">">
                        ...
                        <el-breadcrumb-item class="breadcrumbColor">非道路移动机械备案</el-breadcrumb-item>
                    </el-breadcrumb>
                </div>
            </el-header>
            <el-main>
...
<div style="background: #fff;">
    <el-table :data="tableData" style="width: 100vw;">
        ...
        <el-table-column prop="环保登记编码" label="环保登记编码" width="100" />
        <el-table-column prop="机械环保代码" label="机械环保代码" width="100" />
        <el-table-column prop="车辆铭牌照片" label="车辆铭牌照片" width="100" />
        <el-table-column prop="随车清单" label="随车清单" width="100" />
        <el-table-column prop="行驶证" label="行驶证" width="100" />
        <el-table-column prop="排放阶段" label="排放阶段" width="100" />
        <el-table-column prop="注册日期" label="注册日期" width="140" />
