            ...
            <el-main>
                ...
                <div style="background: #fff;">
                    <el-table :data="tableData" style="width: 100vw;">
                        ...
                        <el-table-column prop="手机号" label="手机号" width="100" />
                        <el-table-column prop="角色" label="角色" width="100" />
    ...
    <div style="width:90%">
        <el-form ref="ruleFormRef" :model="ruleForm" status-icon :rules="rules" label-width="120px" class="demo-ruleForm">
            ...
            <el-form-item label="登录密码" prop="password">
                <div>
                    <el-input v-model="ruleForm.password" placeholder="请输入" autocomplete="off" />
                </div>
                <div style="margin-left: 10px;">
                    <span style="font-size: 2px;color: #888;">要求包含:英文大小写+数字,不少于6位</span>
                </div>
            </el-form-item>
